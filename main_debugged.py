...
# Replace values in the 'prognosis' column using map
prognosis_mapping = {'Fungal infection': 0, 'Allergy': 1, 'GERD': 2, 'Chronic cholestasis': 3,
...
df['prognosis'] = df['prognosis'].map(prognosis_mapping)
...
# Replace values in the 'prognosis' column using map
tr['prognosis'] = tr['prognosis'].map(prognosis_mapping)
...
root = Tk()
root.configure(background="#474448")
...
# Heading
w2 = Label(root, justify=LEFT, text="Advanced Disease Predictor\nA project by Arjun Omkar Arindam",
           fg="ivory", bg="#2D232E")
w2.config(font=("Oswald", 30))
w2.grid(row=1, column=0, columnspan=2, padx=0)


# labels
NameLb = Label(root, text="Name of the Patient", fg="black", bg="#E0DDCF")
NameLb.grid(row=5, column=1, pady=15, sticky=W)

S1Lb = Label(root, text="Symptom 1", fg="#E0DDCF", bg="#534B52")
S1Lb.grid(row=7, column=1, pady=10, sticky=W)

S2Lb = Label(root, text="Symptom 2", fg="#E0DDCF", bg="#534B52")
S2Lb.grid(row=8, column=1, pady=10, sticky=W)

S3Lb = Label(root, text="Symptom 3", fg="#E0DDCF", bg="#534B52")
...
dst = Button(root, text="Result", command=DecisionTree, bg="#E0DDCF", fg="BLACK")
dst.grid(row=17, column=1, padx=10)

# textfileds
t1 = Text(root, height=1, width=40, bg="#ffeecc", fg="black")
